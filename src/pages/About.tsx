    ...
    <div className="w-full min-h-screen bg-luxury-dark text-white pt-32 pb-24 px-6 md:px-12 font-sans relative z-40">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-sm tracking-[2px] uppercase text-brand-stone mt-4">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-stone">Zero legal risks. Every plot, flat, and land deed undergoes direct title analysis.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-stone">Achieving balance. We represent your interest to obtain fair terms and values.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-stone">From joint-venture frameworks to deeds, everything is structured and registry-ready.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="flex flex-col gap-3">
                ...
                <p className="text-xs text-brand-stone leading-relaxed">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
