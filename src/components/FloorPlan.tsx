...
export const FloorPlan: React.FC<FloorPlanProps> = ({ darkMode }) => {
  const strokeColor = darkMode ? 'rgba(255, 255, 255, 0.75)' : 'rgba(255, 255, 255, 0.45)'
  ...
  return (
    <svg
      ...
      style={{ filter: darkMode ? 'drop-shadow(0 0 6px rgba(255,255,255,0.1))' : 'none' }}
    >
      ...
      {/* Swimming Pool Deck (Accent Area) */}
      <rect
        x="200"
        y="180"
        width="130"
        height="60"
        fill={darkMode ? 'rgba(212, 175, 55, 0.05)' : 'rgba(212, 175, 55, 0.15)'}
        stroke={accentColor}
        strokeWidth="1.5"
      />

      {/* Columns / Pillars (Architectural Dots) */}
